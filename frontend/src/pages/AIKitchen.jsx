...
export default function AIKitchen() {
  ...
  const groceryItems = useMemo(() => {
    ...
    function cleanGroceryName(rawValue) {
      ...
      value = value.replace(/^\s*(?:\d+\s+)?\d*\/?\d+(?:\.\d+)?\s*/i, "");
    ...
    <main className="ai-kitchen-page">
      ...
      <section className="ai-kitchen-hero">
        <div className="ai-kitchen-hero-copy">
          ...
          <span className="ai-kitchen-eyebrow">YOUR AI COOKING COMPANION</span>

          <h1>
            Turn what you have into something <span>delicious.</span>
          </h1>

          <p>
            Add the ingredients already available in your kitchen. FoodKindl AI
            can decide what you can cook and create the complete recipe for you.
          </p>
        </div>
        ...
        <div className="ai-kitchen-tips-card">
          <div className="ai-kitchen-tips-header">
            ...
            <strong>Get better recipe ideas</strong>
          </div>

          <div className="ai-kitchen-tip-list">
            <span>
              <Utensils size={14} />
              Add the ingredients you actually have at home.
            </span>

            <span>
              <Utensils size={14} />
              FoodKindl AI will choose a suitable dish automatically.
            </span>

            <span>
              <Utensils size={14} />
              Pantry basics may be suggested as optional additions.
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="ai-kitchen-language-card">
        ...
        <div>
          ...
          <p>
            ...
            Regional-language or local ingredient names may not always be
            recognised correctly.
          </p>

          <span>Regional language support is coming soon.</span>
        </div>
      </section>
...
====================================================== */}
      ...
      <section className="ai-kitchen-ai-disclaimer">
        ...
        <div>
          ...
          <p>
            FoodKindl AI may occasionally provide inaccurate ingredient
            quantities, cooking times or instructions. Please review the recipe
            and use your own judgement while cooking.
          </p>

          <span>
            Always check allergies, dietary restrictions and food-safety
            requirements before preparing or consuming food.
          </span>
        </div>
      </section>
      ...
      <section className="ai-kitchen-mode-section">
        <div className="ai-kitchen-mode-header">
          <div>
            <span>CHOOSE HOW YOU WANT TO COOK</span>

            <h2>What can FoodKindl AI help you with?</h2>
          </div>
        </div>
        ...
        <div className="ai-kitchen-tabs">
          <button
            ...
            className={
              activeTab === "ingredients"
                ? "ai-kitchen-tab " + "ai-kitchen-tab-ingredients " + "active"
                : "ai-kitchen-tab " + "ai-kitchen-tab-ingredients"
            }
          ...
          >
            ...
            <span className="ai-kitchen-tab-copy">
              ...
              <strong>Cook With My Ingredients</strong>

              <em>Add what you have. AI chooses the dish.</em>
            </span>

            <Sparkles size={15} className="ai-kitchen-tab-sparkle" />
          </button>
          ...
          >
            ...
            <span className="ai-kitchen-tab-copy">
              <small>RECIPE SEARCH</small>

              <strong>I Know What I Want</strong>

              <em>Enter a dish name and generate its recipe.</em>
            </span>
          </button>
        </div>
          ...
          <div className="ai-ingredients-workspace">
            ...
            <div className="ai-ingredient-example">
              ...
              <div>
                ...
                <p>
                  Tomato + onion + garlic can become Tomato Curry. Chicken +
                  tomato + onion can become Chicken Curry.
                </p>
              </div>
            </div>
        ...
        {activeTab === "discover" && (
          <div className="ai-kitchen-workspace">
            <div className="ai-kitchen-workspace-header">
              <div>
                <span>FOODKINDL AI RECIPE STUDIO</span>

                <h2>Search for a specific dish</h2>
              </div>
